...
const Home = () => {
  return (
    <div className="mt-16 ml-12 mr-2 mb-10 flex flex-col justify-center items-center sm:ml-24 sm:mr-10 lg:mt-28">
      ...
      <h1 className="text-center text-2xl font-semibold mb-1 mt-4 sm:text-2xl md:text-3xl lg:text-4xl">
        Sugam Bajracharya
      </h1>
      <p className="mb-3 text-xl text-center md:text-2xl mt-1 lg:3xl lg:mt-2">
        I'm a Student
      </p>
