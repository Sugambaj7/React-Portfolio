  ...
  return (
    <div className="timeline_item relative pb-7 pl-8 leading-7">
      <div className="flex flex-row">
        ...
        <span className="timeline__date text-md text-stone-500 sm:text-xl">{props.year}</span>
      </div>
      <h3 className="timeline__title font-bold text-lg sm:text-xl">
        {props.title}
      </h3>
      <p className="timeline__desc mt-2 text-stone-500 sm:text-lg">{props.description}</p>
    </div>
  );
};
